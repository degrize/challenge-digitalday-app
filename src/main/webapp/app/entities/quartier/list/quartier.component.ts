...
import { EntityArrayResponseType, QuartierService } from '../service/quartier.service';
...
export class QuartierComponent implements OnInit {
  ...
  trackId = (_index: number, item: IQuartier): number => this.quartierService.getQuartierIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.quartiers = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IQuartier[] | null): IQuartier[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.quartierService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
