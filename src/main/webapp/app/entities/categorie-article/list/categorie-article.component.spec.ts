...
describe('CategorieArticle Management Component', () => {
  let comp: CategorieArticleComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'categorie-article', component: CategorieArticleComponent }]),
      ...
      .overrideTemplate(CategorieArticleComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.categorieArticles?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to categorieArticleService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCategorieArticleIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCategorieArticleIdentifier).toHaveBeenCalledWith(entity);
